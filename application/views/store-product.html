...
<head>
  ...
  <body>
	...
	<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
            	...
            	<div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 pm-column-spacing">
                            ...
                            <ul class="pm-woocomm-item-thumbs">
                                <li><a href="#"><span></span><i class="fa fa-expand"></i></a><img src="img/store/thumb2.jpg" class="img-responsive" width="180" height="148"></li>
                                <li><a href="#"><span></span><i class="fa fa-expand"></i></a><img src="img/store/thumb3.jpg" class="img-responsive" width="180" height="148"></li>
                            </ul>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <p class="pm-woocom-item-review">(1 Customer Review)</p>
                            ...
                            <div class="pm-woocom-tags-container">
                                ...
                                <div class="product_meta">
                                    ...
                                    <span class="posted_in"> Categories: <a rel="tag" href="#">Programming</a> </span>
                                    <span class="tagged_as"> Tags: <a rel="tag" href="#">coding</a>, <a rel="tag" href="#">programming</a> </span>
        ...
        <!-- Related products -->
        <div class="container pm-containerPadding-top-100 pm-containerPadding-bottom-20">
        
        	<div class="row">
            
            	<div class="col-lg-12 pm-column-spacing">
                	<h4 class="body">related products</h4>
            ...
            <div class="row">
            	...
            	<div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                    ...
                    <div class="pm-store-item-container">
                        ...
                        <a href="#" class="pm-square-btn store-btn">View Details</a>
                    </div>
                    <!-- Product 4 end -->
