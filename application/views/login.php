...
<head>
  ...
  <body>
	...
	<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
        ...
        <div class="pm-sub-header-container">
            ...
            <div class="pm-sub-header-title-container">
                ...
                <div class="pm-sub-header-title-bg">
                    ...
                    <p class="pm-sub-header-title">Login</p>
                    <p class="pm-sub-header-message">SPECIAL BENEFITS FOR OUR MEMBERS</p>
        ...
        <div class="pm-column-container pm-containerMargin60 pm-parallax-panel" style="background-color:#182433; background-image:url(img/gym-wallpaper_1_1920x1200.jpg);" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
                ...
                <div class="row">
                    ...
                    <form action="#" method="post" id="pm-contact-form">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="pm_s_first_name" id="pm_s_first_name" class="pm-form-textfield" type="text" placeholder="User Name *">
                        </div>

                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="pm_s_email_address" id="pm_s_email_address" class="pm-form-textfield" type="text" placeholder="Password *">
                        </div>
                        
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <div class = "row" style="float: right;">
                            <input style="display:inline-block;" type="button" value="Sign Up" name="pm-form-submit-btn" class="pm-form-submit-btn" id="pm-contact-form-btn" onClick="location.href = '<?php echo base_url(); ?>registration'">

                            <div style = "display:inline-block; width:30px;" ></div>
                            <a href="<?php echo base_url(); ?>admin">
                                <input style="display:inline-block;" type="button" value="Log In" name="pm-form-submit-btn" class="pm-form-submit-btn" id="pm-contact-form-btn">       
                            </a>
                        </div>
                        </div>
