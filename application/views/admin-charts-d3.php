...
<!-- Mirrored from myadmin-html.axiomthemes.com/charts-d3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2016 11:37:19 GMT -->
<head>
    <!-- Meta and Title -->
    <meta charset="utf-8">
...
<body class="charts-d3" data-spy="scroll" data-target="#nav-spy" data-offset="260">
        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">D3 Charts</li>
                </ol>
            </div>
        </header>
        <!-- /Topbar -->
        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <aside class="chute chute-left chute290 chute-icon-style bg-info" data-chute-height="match">
                ...
                <div class="chute-container">
                    <div id="nav-spy">
                        <ul class="nav chute-nav" data-smoothscroll="-80" data-spy="affix" data-offset-top="200">
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart1">Area Chart</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>#pchart2">Bar Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart3">Combined Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart4">Donut Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart5">Guage Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart6">Line Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart7">MouseWheel Zoom Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart8">Pie Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart9">Scatter Plot Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart10">Spline Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart11">Step Chart</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>#pchart12">Sub Nav Chart</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="chute chute-center">
                ...
                <div class="panel" id="pchart1">
                    <div class="panel-heading">
                        <span class="panel-title"> Area Chart</span>
                    </div>
                ...
                <div class="panel" id="pchart2">
                    <div class="panel-heading">
                        <span class="panel-title"> Bar Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                ...
                <div class="panel" id="pchart3">
                    <div class="panel-heading">
                        <span class="panel-title"> Combined Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                        <div id="combo-chart" style="height: 350px; width: 100%;"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="pchart4">
                    <div class="panel-heading">
                        <span class="panel-title"> Donut Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                ...
                <div class="panel" id="pchart5">
                    <div class="panel-heading">
                        <span class="panel-title"> Guage Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                        <div id="guage-chart" style="height: 350px; width: 100%;"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="pchart6">
                    <div class="panel-heading">
                        <span class="panel-title"> Line Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                ...
                <div class="panel" id="pchart7">
                    <div class="panel-heading">
                        <span class="panel-title"> MouseWheel Zoom Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                        <div id="zoom-chart" style="height: 350px; width: 100%;"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="pchart9">
                    <div class="panel-heading">
                        <span class="panel-title"> Scatter Plot Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                        <div id="scatter-chart" style="height: 350px; width: 100%;"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="pchart10">
                    <div class="panel-heading">
                        <span class="panel-title"> Spline Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                        <div id="spline-chart" style="height: 350px; width: 100%;"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="pchart11">
                    <div class="panel-heading">
                        <span class="panel-title"> Step Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
                        <div id="step-chart" style="height: 350px; width: 100%;"></div>
                    </div>
                </div>
                ...
                <div class="panel" id="pchart12">
                    <div class="panel-heading">
                        <span class="panel-title"> Sub Navigation Chart</span>
                    </div>
                    <div class="panel-body bg-light dark">
...
<!-- Page JS -->
<script src="<?php echo base_url(); ?>assets/js/demo/charts/d3.js"></script>
