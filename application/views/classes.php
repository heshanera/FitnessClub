	...
	<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
        ...
        <div class="pm-sub-header-container">
        	...
        	<div class="pm-sub-header-title-container">
            	...
            	<div class="pm-sub-header-title-bg">
                	...
                	<p class="pm-sub-header-title">classes</p>
                	<p class="pm-sub-header-message">we offer a wide range of specialty classes</p>
        ...
        <div class="container pm-containerPadding-top-20 pm-containerPadding-bottom-80">
            ...
            <div class="row">
            	...
            	<!-- Column 1 -->
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0.3s" data-wow-offset="50" data-wow-duration="1s">
                	
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post1.jpg);">
                        ...
                        <div class="pm-class-post-details-container">
                            ...
                            <div class="pm-class-post-info">
                                ...
                                <p class="excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc fringilla erat nec tellus consectetur sodales. Vivamus quis est eget velit scelerisque condimentum sed non lorem. <a href="#">[...]</a></p>
                                
                                <a href="#" class="pm-square-btn">read more</a>
                ...
                <!-- Column 2 -->
                <div class="col-lg-4 col-md-6 col-sm-12 desktop wow fadeInUp animated
" data-wow-delay="0.6s" data-wow-offset="50" data-wow-duration="1s">
                    
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post2.jpg);">
                ...
                <!-- Column 3 -->
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp animated
" data-wow-delay="0.9s" data-wow-offset="50" data-wow-duration="1s">
                    
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post3.jpg);">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0.3s" data-wow-offset="50" data-wow-duration="1s">
                    ...
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post4.jpg);">
...
" data-wow-delay="0.6s" data-wow-offset="50" data-wow-duration="1s">
                    ...
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post5.jpg);">
...
" data-wow-delay="0.9s" data-wow-offset="50" data-wow-duration="1s">
                    ...
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post6.jpg);">
                        ...
                        <div class="pm-class-post-details-container">
                            ...
                            <div class="pm-class-post-info">
                                ...
                                <p class="title">ab, butt & leg blast</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp animated" data-wow-delay="0.3s" data-wow-offset="50" data-wow-duration="1s">
                    ...
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post7.jpg);">
...
" data-wow-delay="0.6s" data-wow-offset="50" data-wow-duration="1s">
                    ...
                    <!-- Class post -->
                    <div class="pm-class-post" role="class" style="background-image:url(img/classes/post8.jpg);">
...
<!-- Mirrored from projects.pulsarmedia.ca/energy/classes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Nov 2016 13:44:41 GMT -->
</html>
