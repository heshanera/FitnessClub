  ...
  <body>
	...
	<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
        ...
        <!-- BODY CONTENT starts here -->
       	...
       	<!-- PANEL 1 -->
        <div class="container pm-containerPadding-top-30 pm-containerPadding-bottom-40">
            
            <div class="row">
            
            	<!-- Column 1 -->
                <div class="col-lg-6 col-md-6 col-sm-12 pm-column-spacing pm-center-mobile">
                    
                    <h2>CONTACT INFORMATION</h2>
                    
                    <div class="pm-divider pm-divider-mobile"></div>
                    
                    <p><b>PHONE:</b> 416.555.5555</p>
                    
                    <p><b>FAX:</b> 416.555.5556</p>
                    
                    <p><b>EMAIL:</b> <a href="mailto:info@energyfitness.com">INFO@ENERGYFITNESS.COM</a></p>
